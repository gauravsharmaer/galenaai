...
//to navigate to stripe checkout page and this data is the one we defined in stripe checkout
}
    ...
    <div>
      ...
      <div className="bg-white text-orange-400 text-center mx-6 py-7 relative bottom-16 rounded-lg sm:w-[25%] sm:bottom-36 sm:left-48">
        ...
        <p className="font-light mb-2">
          <AiOutlineCheck size={25} className="relative top-6 left-14" /> 5 queries/week
        </p>
        <p className="font-light mb-2">
          <AiOutlineCheck size={25} className="relative top-6 left-14" /> Free forever
        </p>
        <p className="font-light mb-3">
          <AiOutlineCheck size={25} className="relative top-6 left-14" /> Email Support
        </p>
      ...
      <div className="bg-white text-orange-400 text-center mx-6 py-7 relative rounded-lg sm:w-[30%] sm:left-[37%] sm:bottom-[32rem]">
        ...
        <p className="font-light mb-2">
          <AiOutlineCheck size={25} className="relative top-6 left-14" /> Unlimited questions
        </p>
        <p className="font-light mb-2">
          <AiOutlineCheck size={25} className="relative top-6 left-14" /> All products available
        </p>
        <p className="font-light mb-7">
          <AiOutlineCheck size={25} className="relative top-6 left-14" /> Cancel anytime
        </p>
        <button className="text-white bg-orange-400 px-28 py-2 rounded-md" onClick={handleSubscription}>
         SUBSCRIBE
        </button>
      </div>
      ...
      <div className="bg-white text-orange-400 text-center mx-6 py-7 relative rounded-lg sm:w-[30%] sm:left-[63%] sm:bottom-[54rem]">
        ...
        <p className="font-light mb-2 sm:mb-0">
          <AiOutlineCheck size={25} className="relative top-6 left-14" /> API available
        </p>
        <p className="font-light mb-2 sm:mb-0">
          <AiOutlineCheck size={25} className="relative top-6 left-7 sm:left-14" /> Premium integration support
        </p>
        <p className="font-light mb-3 sm:mb-0">
          <AiOutlineCheck size={25} className="relative top-6 left-14" /> Bring your own Data
        </p>
        <p className="font-light mb-3">
          <AiOutlineCheck size={25} className="relative top-6 left-14" /> Per use pricing
        </p>
        <button className="text-white bg-orange-400 px-28 py-2 rounded-md">
