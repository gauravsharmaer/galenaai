  ...
  return (
    <div className="m-12 sm:px-[17rem]">
      ...
      <div className="my-7">
        ...
        <p className="text-lg pr-5">This model is the most accurate; however, it can be slow. It is powered by GPT-4 and all available references in our database. This mode provides the most accurate answers and the best references. We highly recommend using it for advanced questions.</p>
      </div>

      <div className="my-7">
        <h2 className="font-bold mb-5 text-xl">Specialized Products</h2>
        <p className="text-lg pr-5">In addition to our main product, we also offer specialized products for specific use cases. These products are usually requested by organizations we work with and should be considered as working demos. Organizations can request a specialized product for their use case.</p>
      </div>
    </div>
  );
};
